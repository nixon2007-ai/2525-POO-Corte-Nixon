 ...
 */
package registrodeingresoalgaragelucimar;

import registrodeingresoalgarage.Carro;
import registrodeingresoalgarage.RegistroIngreso;
...
public class Registrodeingresoalgaragelucimar {
    public static void main(String[] args) {
        System.out.println("Bienvenidos al registro de ingreso vehicular al Garage LUCIMAR");
        // Crear carros
